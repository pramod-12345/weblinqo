      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
          ...
          <p className="mb-6 text-gray-600">
            At weblinqo, your privacy is important to us. This policy explains what data we collect and how we use it.
          </p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600">
                We collect information such as your name, email, and usage behavior to improve our services.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600">
                Your data is used solely for improving user experience and will never be sold or shared with third parties.
              </p>
            </div>
            
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-3">3. Cookies</h2>
              <p className="text-gray-600">
                We use cookies to understand user behavior and enhance your experience.
              </p>
            </div>
          </div>
